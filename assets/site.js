...
const COPY = {
  ko: {
    ...
    skip: "본문으로 건너뛰기", homeAria: "AFTERPACE 홈", primaryNavAria: "주요 메뉴", languageAria: "언어", highlightsAria: "주요 특징", directionsAria: "여섯 가지 아트 디렉션", navWhy: "이유", navDirections: "아트 디렉션", navFeatures: "기능", navPrivacy: "프라이버시", storeShort: "App Store 준비 중",
    ...
    downloadOn: "Download on the", appStoreSoon: "App Store · 출시 준비 중", seeHow: "어떻게 완성되는지 보기", trustHealth: "Apple Health", trustPrivate: "로컬 우선", trustRatios: "3개 비율",
    ...
    availabilityEyebrow: "COMING TO iPHONE & iPAD", availabilityTitle: "다음 운동은,|남기고 싶은 장면이 됩니다.", availabilityBody: "App Store 공개 페이지를 준비하고 있습니다. 출시 전까지 제품 소식과 지원은 GitHub에서 확인할 수 있습니다.", appStoreLabel: "App Store", comingSoon: "출시 준비 중", viewGithub: "GitHub에서 보기",
    footerPrivacy: "개인정보처리방침", footerTerms: "서비스 이용약관", footerSupport: "지원", appIconAlt: "AFTERPACE 앱 아이콘", workspaceAria: "경로와 운동 메트릭을 편집하는 AFTERPACE Quick Edit 워크스페이스"
  },
  en: {
    ...
    skip: "Skip to content", homeAria: "AFTERPACE home", primaryNavAria: "Primary navigation", languageAria: "Language", highlightsAria: "Highlights", directionsAria: "Six art directions", navWhy: "Why", navDirections: "Directions", navFeatures: "Features", navPrivacy: "Privacy", storeShort: "App Store · Coming soon",
    ...
    downloadOn: "Download on the", appStoreSoon: "App Store · Coming soon", seeHow: "See how it comes together", trustHealth: "Apple Health", trustPrivate: "Local first", trustRatios: "3 ratios",
    ...
    availabilityEyebrow: "COMING TO iPHONE & iPAD", availabilityTitle: "Your next workout|can become the scene you keep.", availabilityBody: "The public App Store page is in preparation. Until launch, follow product updates and get support on GitHub.", appStoreLabel: "App Store", comingSoon: "Coming soon", viewGithub: "View on GitHub",
    footerPrivacy: "Privacy Policy", footerTerms: "Service Terms", footerSupport: "Support", appIconAlt: "AFTERPACE app icon", workspaceAria: "AFTERPACE Quick Edit workspace for editing a route and workout metrics"
  },
  ja: {
    ...
    skip: "本文へ移動", homeAria: "AFTERPACE ホーム", primaryNavAria: "メインナビゲーション", languageAria: "言語", highlightsAria: "主な特徴", directionsAria: "6つのアートディレクション", navWhy: "想い", navDirections: "デザイン", navFeatures: "機能", navPrivacy: "プライバシー", storeShort: "App Store · 近日公開",
    ...
    downloadOn: "Download on the", appStoreSoon: "App Store · 近日公開", seeHow: "仕上がる流れを見る", trustHealth: "Apple Health", trustPrivate: "ローカル優先", trustRatios: "3つの比率",
    ...
    availabilityEyebrow: "COMING TO iPHONE & iPAD", availabilityTitle: "次のワークアウトが、|残したい一枚になる。", availabilityBody: "App Storeの公開ページを準備中です。リリースまではGitHubで最新情報とサポートをご確認ください。", appStoreLabel: "App Store", comingSoon: "近日公開", viewGithub: "GitHubで見る",
    footerPrivacy: "プライバシーポリシー", footerTerms: "サービス利用規約", footerSupport: "サポート", appIconAlt: "AFTERPACEアプリアイコン", workspaceAria: "ルートとワークアウト指標を編集するAFTERPACE Quick Editワークスペース"
  }
};
